...
import { ASSET_NAME_TO_URL, VIDEO_NAME_TO_URL } from './assets.ts'
import infoSvgPath from '~/assets/media/info.svg?url'
import warningSvgPath from '~/assets/media/warning.svg?url'
import rehypeAdmonition from '~/markdown/rehype-admonition.ts'
import rehypeCodeTitle from '~/markdown/rehype-code-title.ts'
import rehypeFootnoteBackref from '~/markdown/rehype-footnote-backref.ts'
import rehypeHeadingAnchors from '~/markdown/rehype-heading-anchors.ts'
import rehypeTableWrapper from '~/markdown/rehype-table-wrapper.ts'
import remarkUnknownDirective from '~/markdown/remark-unknown-directive.ts'
...
const markdownToHtmlProcessor = unified()
  ...
  .use(rehypeExternalLinks, {
    target: `_blank`,
    rel: [`noopener`, `noreferrer`],
    properties: { className: [`focus-ring`] },
  })
  .use(rehypeSlug)
  .use(rehypeMermaid, {
  ...
  // These HAST transforms run in the pipeline so post bodies stringify to
  // plain, zero-JavaScript HTML.
