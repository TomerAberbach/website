...
const BaseTooltip = ({
  ...
  <span className='relative leading-[0]'>
    <span className='peer block h-full'>{children}</span>
    <span
      id={id}
      className="pointer-events-none absolute top-[calc(120%+8px)] left-1/2 z-10 inline-block w-max -translate-x-1/2 rounded-md bg-gray-800 p-2 text-center text-xs text-white opacity-0 transition-opacity duration-200 peer-focus-within:pointer-events-auto peer-focus-within:opacity-100 peer-hover:pointer-events-auto peer-hover:opacity-100 peer-active:pointer-events-auto peer-active:opacity-100 after:absolute after:top-0 after:left-1/2 after:-translate-x-1/2 after:-translate-y-full after:border-8 after:border-solid after:border-transparent after:border-b-gray-800 after:content-[''] hover:pointer-events-auto hover:opacity-100 active:pointer-events-auto active:opacity-100"
